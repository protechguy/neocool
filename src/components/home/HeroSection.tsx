...
export function HeroSection() {
  return (
    ...
    >
      ...
      {/* Cold haze spots */}
      <div className="cold-haze hidden sm:block w-[500px] h-[300px] bottom-[10%] left-[-5%] z-[2]" />
      <div className="cold-haze hidden sm:block w-[400px] h-[250px] bottom-[5%] right-[-5%] z-[2]" style={{ animationDelay: "3s" }} />
      <div className="cold-haze hidden sm:block w-[300px] h-[200px] top-[20%] left-[10%] z-[2]" style={{ animationDelay: "5s" }} />
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-white leading-[0.95] tracking-tight drop-shadow-[0_2px_20px_rgba(0,0,0,0.5)]">
            Keep Your<br />
          ...
          <p className="mt-6 text-base sm:text-lg md:text-xl text-white/70 max-w-xl mx-auto leading-relaxed drop-shadow-[0_1px_8px_rgba(0,0,0,0.4)]">
        ...
        >
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-4xl sm:text-5xl md:text-6xl font-bold text-red-400 pulse-warm rounded-2xl px-6 py-3">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-4xl sm:text-5xl md:text-6xl font-bold text-ice-blue pulse-cool rounded-2xl px-6 py-3">
